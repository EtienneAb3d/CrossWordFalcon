#!/usr/bin/env bash
# One-shot: build every data artefact for the English
...
# logs/build_en.log. Safe to re-run: every build_*.py step reuses its
...
step "DONE — English data pipeline complete"
ls -la data/wordlist_en_full.tsv data/gloss_dictionary/en_glosses.jsonl \
       data/reference_corpus_en.tar.xz data/reference_corpus/en_sentences.txt data/inflection/en.jsonl 2>&1
