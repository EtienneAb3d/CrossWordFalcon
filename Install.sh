...
echo "                      Alternative (GPU, plus recent, plus lent) : Qwen3-Embedding-0.6B"
echo "                      -- voir le bloc commente dans env_default.sh pour les 3"
echo "                      exports a decommenter. Necessite ensuite un rebuild complet"
echo "                      de Qdrant (voir ci-dessous), l'espace vectoriel change avec"
echo "                      le modele."
